    ...
    >
      ...
      <div>
        ...
        <p style={{ fontSize: 40, lineHeight: 1.4, color: palette.muted, margin: '36px 0 0', maxWidth: 1200 }}>
          How packets reach your service — and how you reach your servers.
        </p>

        <div style={{ marginTop: 56, display: 'flex', flexDirection: 'column', gap: 16 }}>
          <Topic label="TCP/IP, DNS, the routing path" />
          <Topic label="NAT, firewalls, security groups" />
          <Topic label="SSH keys, agents, jump hosts, tunnels" />
          <Topic label="debugging with curl, dig, tcpdump" />
        </div>
      </div>
...
export const meta: SlideMeta = { title: 'Networking & SSH' };
