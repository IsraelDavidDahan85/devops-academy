    ...
    >
      ...
      <div>
        ...
        <p style={{ fontSize: 40, lineHeight: 1.4, color: palette.muted, margin: '36px 0 0', maxWidth: 1200 }}>
          Version-control your servers, networks, and clusters — no more clicking around the AWS console.
        </p>

        <div style={{ marginTop: 56, display: 'flex', flexDirection: 'column', gap: 16 }}>
          <Topic label="Terraform — providers, resources, state" />
          <Topic label="Ansible — playbooks, roles, idempotence" />
          <Topic label="drift, plan, apply, destroy" />
          <Topic label="modules, environments, best practices" />
        </div>
      </div>
...
export const meta: SlideMeta = { title: 'Infrastructure as Code' };
