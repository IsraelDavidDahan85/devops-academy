  ...
  <div style={fill}>
    ...
    >
      ...
      <div>
        ...
        >
          Turn one-liners into reliable automation — scripts that other engineers can actually depend on.
        </p>

        <div style={{ marginTop: 56, display: 'flex', flexDirection: 'column', gap: 16 }}>
          <Topic label="bash syntax, variables, quoting" />
          <Topic label="control flow, loops, functions" />
          <Topic label="arguments, flags, exit codes" />
          <Topic label="robust scripts — set -euo, traps, tests" />
        </div>
      </div>
...
export const meta: SlideMeta = { title: 'Shell Scripting' };
