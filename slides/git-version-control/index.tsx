    ...
    >
      ...
      <div>
        ...
        <p style={{ fontSize: 40, lineHeight: 1.4, color: palette.muted, margin: '36px 0 0', maxWidth: 1200 }}>
          Track every change. Collaborate without conflict. Undo with confidence.
        </p>

        <div style={{ marginTop: 56, display: 'flex', flexDirection: 'column', gap: 16 }}>
          <Topic label="commits, branches, merges" />
          <Topic label="remotes, push / pull, pull requests" />
          <Topic label="rebase, cherry-pick, reflog" />
          <Topic label="workflows that scale to a team" />
        </div>
      </div>
...
export const meta: SlideMeta = { title: 'Git & Version Control' };
