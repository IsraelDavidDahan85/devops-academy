    ...
    >
      ...
      <div>
        ...
        <p style={{ fontSize: 40, lineHeight: 1.4, color: palette.muted, margin: '36px 0 0', maxWidth: 1200 }}>
          Pull it all together — ship a real DevOps project end-to-end and present what you built.
        </p>

        <div style={{ marginTop: 56, display: 'flex', flexDirection: 'column', gap: 16 }}>
          <Topic label="scope your scenario" />
          <Topic label="build the pipeline" />
          <Topic label="deploy, observe, iterate" />
          <Topic label="present what you built" />
        </div>
      </div>
...
export const meta: SlideMeta = { title: 'Capstone Project' };
