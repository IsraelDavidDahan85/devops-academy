    ...
    >
      ...
      <div>
        ...
        <p style={{ fontSize: 40, lineHeight: 1.4, color: palette.muted, margin: '36px 0 0', maxWidth: 1200 }}>
          See what your system is actually doing — before users complain.
        </p>

        <div style={{ marginTop: 56, display: 'flex', flexDirection: 'column', gap: 16 }}>
          <Topic label="logs — structured, centralized, searchable" />
          <Topic label="metrics — Prometheus, Grafana, RED/USE" />
          <Topic label="traces — OpenTelemetry, distributed systems" />
          <Topic label="alerts that wake the right person" />
        </div>
      </div>
...
export const meta: SlideMeta = { title: 'Observability' };
